package com.harrisonog.taper_android.ui.navigation
...
import com.harrisonog.taper_android.ui.screens.HabitDetailScreen
import com.harrisonog.taper_android.ui.screens.HabitEditorScreen
import com.harrisonog.taper_android.ui.screens.HabitListScreen
...
private fun habitListViewModelFactory(repository: TaperRepository) =
    simpleFactory { HabitListViewModel(repository) }

private fun habitEditorViewModelFactory(repository: TaperRepository) =
    simpleFactory { HabitEditorViewModel(repository) }

private fun habitDetailViewModelFactory(repository: TaperRepository, habitId: Long) =
